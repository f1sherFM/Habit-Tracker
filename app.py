...
class Habit(db.Model):
    ...
    habit_type = db.Column(db.String(20), default='useful', nullable=False)  # 'useful' or 'pleasant'
    ...
    def __repr__(self):
        return f'<Habit {self.name} ({self.habit_type})>'
    ...
    def is_pleasant_habit(self):
        ...
        return self.habit_type == 'pleasant'
    
    def is_useful_habit(self):
        """Check if this is a useful habit"""
        return self.habit_type == 'useful'
